...
TEXT_PROMPT = "Woman wearing a black tank top and blue shorts, standing on a wooden floor with her hands on her hips."
#IMG_PATH = "/share_io03_ssd/test2/shijiapeng/ActivityNet_annotations_24_8/ActivityNet_frames/0dZVZtTTgfk/01515.jpg"
IMG_PATH = f"/share_io02_hdd/shijiapeng/STVG_datasets/vidstg/exp/frames/{vid}/00302.jpg"
SAM2_CHECKPOINT = "./checkpoints/sam2.1_hiera_large.pt"
SAM2_MODEL_CONFIG = "sam2.1_hiera_l.yaml"
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
#OUTPUT_DIR = Path("outputs/grounded_sam2_hf_model_demo")
OUTPUT_DIR = Path(f"/share_io02_hdd/shijiapeng/STVG_datasets/vidstg/exp/gdino_on_first_frame/{vid}")
